		...
		class Singleton
		{
			...
			public static Singleton GetInstance(string value)
			{
				...
				if (_instance == null)
				{
					 ...
					 * Since there's no Singleton instance yet, multiple threads can simultaneously pass the previous conditional 
					 * and reach this point almost at the same time. The first of them will acquire
